...
def create_content():
    ...
    if category == 'vocabulary':
        if get_param_vocabulary == 'new':
            ...
            content += '<div id="flashcard-control"><span class="six-seconds">6 sec</span><span class="nine-seconds active">9 sec</span><span class="fifteen-seconds">15 sec</span><span class="pause">Pause</span><span class="resume hidden">Resume</span><span class="previous hidden">Previous</span><span class="next hidden">Next</span><span class="stop">Stop</span></div>'
